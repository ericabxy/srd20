...
randomly (50% chance of either color)—blue or green if the *chill shield
*is cast, violet or blue if the *warm shield *is employed. The special
powers of each version are as follows.
...
ready to use, that spell is discharged harmlessly when the *gaseous form
*spell takes effect.
...
<tbody>
<tr class="odd">
<td><h2>Caster Level</h2></td>
<td><h2>Vermin Size</h2></td>
</tr>
<tr class="even">
<td></td>
<td></td>
