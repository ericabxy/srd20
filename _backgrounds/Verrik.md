---
category: Arcana Unearthed
title: Verrik
---

This text is adapted from Chapter Two of _Monte Cook's Arcana Unearthed_ (pp. 23 to 24).
...
* **Innate Spell-Like Abilities:** 1/day—*contact, sense thoughts, lesser telekinesis.* Use the verrik’s character level as the caster level. The verrik cannot use the heightened versions of these spells.
...
* **Bonus Languages:** Any.
* **Racial Levels:** Unlike humans and some other races, verrik can take a few levels in “verrik” as a class to develop their racial qualities more fully.

### Verrik Racial Levels

| Level | Bab | Fort | Ref | Will | Special
| :---: | :-: | :--: | :-: | :--: | -------
| 1     | +1  | +0   | +0  | +2   | Innate spell-like abilities: 1/day—*compelling command, detect magic, disorient,* 3/day—*object loresight*
| 2     | +2  | +0   | +1  | +3   | Innate spell-like abilities: 1/day—*levitate, mind stab, read mind*
| 3     | +3  | +1   | +1  | +3   | Innate spell-like ability: 2/day—*telepathy;* +2 Intelligence or +2 Wisdom (player’s choice)
