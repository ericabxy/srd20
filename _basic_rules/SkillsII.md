...
A creature larger or smaller than Medium takes a size bonus or penalty on Hide checks depending on its size parent: Fine +16, Diminutive +12, Tiny +8, Small +4, Large --4, Huge --8, Gargantuan --12, Colossal --16.
...
<table>
  ...
  <tfoot>
    <tr>
      <td colspan=2>1 Requires a 20-foot running start. Without a running start, double the DC.</td>
    </tr>
  </tfoot>
</table>
...
<table>
  ...
  <tfoot>
    <tr>
      <td colspan=2>1 Not including vertical reach; see below.<br>2 Requires a 20-foot running start. Without a running start, double the DC.</td>
    </tr>
  </tfoot>
</table>
...
<table>
  ...
  <tfoot>
    <tr>
      <td colspan=2>1 If you beat the DC by 10 or more, you can make out what's being said, assuming that you understand the language.</td>
    </tr>
  </tfoot>
</table>
...
<table>
  ...
  <tfoot>
    <tr>
      <td colspan=4>1 Armor check penalty applies.</td>
    </tr>
  </tfoot>
</table>
...
<table>
  ...
  <tfoot>
    <tr>
      <td colspan=2>1 Dwarves (even if they are not rogues) can use Search to find traps built into or out of stone.<br>2 A successful Search check can find a footprint or similar sign of a creature's passage, but it won't let you find or follow a trail. See the Track feat for the appropriate DC.</td>
    </tr>
  </tfoot>
</table>
...
<table>
  ...
  <tfoot>
    <tr>
      <td colspan=2>1 You can't take 10 on a Swim check in stormy water, even if you aren't otherwise being threatened or distracted.</td>
    </tr>
  </tfoot>
</table>
...
<table>
  ...
  <tbody>
    <tr>
      <td>Lightly obstructed (scree, light rubble, shallow bog<sup>1</sup>, undergrowth)</td>
      <td>+2</td>
    </tr>
    <tr>
  ...
  <tfoot>
    <tr>
      <td colspan=2>1 Tumbling is impossible in a deep bog.</td>
    </tr>
  </tfoot>
</table>
...
<table>
  ...
  <tfoot>
    <tr>
      <td colspan=2>1 Add 2 to the DC for every 10 feet the hook is thrown; see below.</td>
    </tr>
  </tfoot>
</table>
