...
#### Table: Ability Modifiers and Bonus Power Points (by Class Level)
...
<table>
  <thead>
    <tr>
      <th colspan=9>Table: The Psion</th>
    </tr>
    <tr>
      <th>Level</th>
...
|                |                |              |                |
+----------------|----------------|--------------|----------------+
| **Owner        | **Natural      | **Int Adj.** | # Special      |
| Level**        | Armor Adj.**   |              |                |
+----------------|----------------|--------------|----------------+
|                |                |              |                |
+----------------|----------------|--------------|----------------+
| 1st--2nd       | +0             | +0           | Alertness,     |
|                |                |              | improved       |
|                |                |              | evasion,       |
|                |                |              | personality,   |
|                |                |              | se             |
...
|                |                |              |                |
+----------------|----------------|--------------|----------------+
| 3rd--4th       | +1             | +1           | Deliver touch  |
|                |                |              | powers         |
+----------------|----------------|--------------|----------------+
| 5th--6th       | +2             | +2           | Telepathic     |
|                |                |              | speech         |
+----------------|----------------|--------------|----------------+
| 7th--8th       | +3             | +3           | ---            |
+----------------|----------------|--------------|----------------+
...
<table>
  <thead>
    <tr>
      <th colspan=9>Table: The Psychic Warrior</th>
    </tr>
    <tr>
      <th>Level</th>
      <th>Base Attack Bonus</th>
  ...
  <tfoot>
    <tr>
      <td colspan=9>*The psychic warrior gains no power points from his class at 1st level. However, he does add any bonus power points he gains from a high Wisdom score, his race, and feats or other sources to his reserve. He can use these points (if any) to manifest his power.</td>
    </tr>
  </tfoot>
</table>
...
**Skill Points at 1st Level:** (4 + Int modifier) &times; 4.
...
<table>
  <thead>
    <tr>
      <th colspan=6>Table: The Soulknife</th>
    </tr>
    <tr>
      <th>Level</th>
      <th>Base Attack Bonus</th>
...
<table>
  <thead>
    <tr>
      <th colspan=9>Table: The Wilder</th>
    </tr>
    <tr>
      <th>Level</th>
      <th>Base Attack Bonus</th>
...
+----------|----------|----------|----------|----------|----------+
| # Level  | # B      | # F      | #        | # W      | # Spe    |
|          | ase Atta | ort Save | Ref Save | ill Save | lls per  |
|          | ck Bonus |          |          |          | Day/Powe |
|          |          |          |          |          | rs Known |
+----------|----------|----------|----------|----------|----------+
|          |          |          |          |          |          |
...
|         |         |         |         |         |         |         |
+---------|---------|---------|---------|---------|---------|---------+
| **      | **Base  | **Fort  | **Ref   | **Will  | **Sp    | *       |
| Level** | Attack  | Save**  | Save**  | Save**  | ecial** | *Powers |
|         | Bonus** |         |         |         |         | Known** |
+---------|---------|---------|---------|---------|---------|---------+
|         |         |         |         |         |         |         |
+---------|---------|---------|---------|---------|---------|---------+
...
+-------|-------|-------|-------|-------|-------|-------|-------|-------+
| **Le  | *     | *     | **Ref | *     | # Sp  | **Po  | **P   | **    |
| vel** | *Base | *Fort | S     | *Will | ecial | ints/ | owers | Level |
|       | A     | S     | ave** | S     |       | Day** | Kn    | Kn    |
|       | ttack | ave** |       | ave** |       |       | own** | own** |
|       | Bo    |       |       |       |       |       |       |       |
|       | nus** |       |       |       |       |       |       |       |
+-------|-------|-------|-------|-------|-------|-------|-------|-------+
|       |       |       |       |       |       |       |       |       |
+-------|-------|-------|-------|-------|-------|-------|-------|-------+
| 1st   | +0    | +0    | +2    | +2    | Monk  | 1     | 1     | 1st   |
|       |       |       |       |       | abil  |       |       |       |
|       |       |       |       |       | ities |       |       |       |
+-------|-------|-------|-------|-------|-------|-------|-------|-------+
| 2nd   | +1    | +0    | +3    | +3    | ---   | 3     | 2     | 1st   |
...
+---------|---------|---------|---------|---------|---------|---------+
| ######  | ####    | ###     | ##      | ###     | #       | ######  |
| # Level | ### Bas | #### Fo | ##### R | #### Wi | ######  | # Power |
|         | e Attac | rt Save | ef Save | ll Save | Special | s Known |
|         | k Bonus |         |         |         |         |         |
+---------|---------|---------|---------|---------|---------|---------+
|         |         |         |         |         |         |         |
+---------|---------|---------|---------|---------|---------|---------+
