...
* Medium-size: no special bonuses or penalties due to size.
* Base land speed is 30 feet.
* Weapon Proficiency: Anglers are proficient with tridents, harpoons, and nets.
* +2 cultural bonus on Use Rope checks. Anglers are taught from a young age about lashing and knot-tying.
* +2 cultural bonus on Balance, Jump, and Swim checks from decades of boating and diving experience.
* Automatic Languages: Anglic. Bonus Languages: Any.
* Favored Class: Any.
