...
Gnolls tend to favor the ranger class.
...
* +2 racial bonus on Handle Animal and Move Silently checks.
...
This background is based on the SRD [Gnoll][1], the _Arcana Unearthed_ [sibeccai](Sibeccai), and the [desert half-orc][2].

[1]: MonstersG#gnolls-as-characters
[2]: https://www.d20srd.org/srd/variant/races/environmentalRacialVariants.htm#desertHalfOrcs
