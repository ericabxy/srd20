...
power, grafting a weapon means that attacks with this hand deal the
base damage of the weapon, instead of the claw upon which a psychic
...
the effect works but the creature simply isn't detected. *Remote viewing
