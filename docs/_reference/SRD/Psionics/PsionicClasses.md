...
+-------+-------+-------+-------+-------+-------+-------+-------+-------+
| **    | *     | *     | **Ref | *     | **Sp  | **    | **P   | **Ma  |
| Level | *Base | *Fort | S     | *Will | ecial | Power | owers | ximum |
| **    | A     | S     | ave** | S     | **    | Poin  | Kn    | Power |
|       | ttack | ave** |       | ave** |       | ts/** | own** | Level |
|       | Bonus |       |       |       |       |       |       | Kn    |
|       | **    |       |       |       |       | **    |       | own** |
|       |       |       |       |       |       | Day** |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+-------+
...
+-------+-------+-------+-------+-------+-------+-------+-------+-------+
| 15th  | +7/+2 | +5    | +5    | +9    | Bonus | 195   | 28    | 8th   |
|       |       |       |       |       | feat  |       |       |       |
+-------+-------+-------+-------+-------+-------+-------+-------+-------+
...
He can use equipment normally, deriving benefits from items that enhance
