...
through the air. You can train a mount to move with the aid of *air walk*
(counts as a trick; see Handle Animal skill) with one week of work and
...
effects of instantaneous conjurations* *are not affected by an
...
*spell, but *arcane sight *does not require concentration and discerns
...
even less and held within some gem, jar, or similar object. The *binding
*is permanent. The subject does not need to breathe, eat, or drink while
*contained*, nor does it age. Reduce the save DC by 4.
