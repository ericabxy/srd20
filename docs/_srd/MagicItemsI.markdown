...
of the item's notational entry. See the *detect magic* spell
...
| Item ** | **      | Cost ** | rial^2^ | **      | S       | Pri     |
|         |         |         | **      |         | upplies | ce^4^** |
|         |         |         |         |         | Cost ** |         |
+---------+---------+---------+---------+---------+---------+---------+
| Armor   | Craft   | Mas     | Cost x  | x 50    | 1/2 the | Value   |
|         | Magic   | terwork | 50      | (       | value   | on      |
|         | Arms    | armor   | (       | usually | on      | Table:  |
|         | and     |         | usually | none)   | Table:  | Armor   |
|         | Armor   |         | none)   |         | Armor   | and     |
|         |         |         |         | x 5 gp  | and     | Shields |
|         |         |         |         |         | Shields |         |
+---------+---------+---------+---------+---------+---------+---------+
| Shield  | Craft   | Mas     | x 50    | x 50   | 1/2 the | Value   |
|         | Magic   | terwork | (       | (       | value   | on      |
|         | Arms    | shield  | usually | usually | on      | Table:  |
|         | and     |         | none)   | none)   | Table:  | Armor   |
|         | Armor   |         |         |         | Armor   | and     |
|         |         |         |         | x 5 gp  | and     | Shields |
|         |         |         |         |         | Shields |         |
+---------+---------+---------+---------+---------+---------+---------+
| Weapon  | Craft   | Mas     | x 50    | x 50    | 1/2 the | Value   |
|         | Magic   | terwork | (       | (       | value   | on      |
|         | Arms    | weapon  | usually | usually | on      | Table:  |
|         | and     |         | none)   | none)   | Table:  | Weapons |
|         | Armor   |         |         |         | Weapons |         |
|         |         |         |         | x 5 gp  |         |         |
+---------+---------+---------+---------+---------+---------+---------+
...
|         |         |         |         |         |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| Rod     | Craft   | **      | x 50    | x 50    | S       | S       |
|         | Rod     | ^1\ ^** | (often  | (often  | pecial, | pecial, |
|         |         |         | none)   | none)   | see     | see     |
|         |         |         |         |         | Table:  | Table:  |
|         |         |         |         |         | Est     | Est     |
|         |         |         |         |         | imating | imating |
...
|         |         |         |         | spell)  |         |         |
+---------+---------+---------+---------+---------+---------+---------+
| Wand    | Craft   | ---     | x 50    | x 50    | 1/2 x   | 375 x   |
|         | Wand    |         |         |         | 375 x   | level   |
|         |         |         |         | x 5 gp  | level   | of      |
|         |         |         |         |         | of      | spell x |
|         |         |         |         |         | spell x | level   |
...
|         |         |         |         |         |        |         |
+---------+---------+---------+---------+---------+---------+---------+
| W       | Craft   | **      | x 50    | x 50    | S       | S       |
| ondrous | W       | ^5\ ^** | (       | (       | pecial, | pecial, |
|         | ondrous |         | usually | usually | see     | see     |
| Item    | Item    |         | none)   | none)   | Table:  | Table:  |
|         |         |         |         |         | Est     | Est     |
|         |         |         |         | x 5 gp  | imating | imating |
|         |         |         |         |         | Magic   | Magic   |
|         |         |         |         |         | Item    | Item    |
|         |         |         |         |         | Gold    | Gold    |
|         |         |         |         |         | Price   | Price   |
