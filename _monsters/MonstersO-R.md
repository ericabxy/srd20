...
---Racial Skills: An ogre's giant levels give it skill points equal to
7 x (2 + Int modifier, minimum 1). Its class skills are Climb, Listen,
and Spot.
...
The ogre mage is a more intelligent and dangerous variety of its
mundane cousin.
...
they prefer to retreat using *gaseous form
*rather than fight a losing battle.

**Spell-Like Abilities:** At
will---*darkness, invisibility; *1/day---
*charm person *(DC 14)*, cone
of cold *(DC 18)*, gaseous form, polymorph,
sleep *(DC 14)*. *Caster level
9th. The save DCs are Charisma-based.

**Flight (Su):** An ogre mage can cease or resume flight
as a free action. While using *gaseous form
*it can fly at its normal speed and has perfect
maneuverability.
...
|                      | Ooze    | Ooze    |
+----------------------+----------------------+----------------------+
| **Hit               || 10d10+60 (115 hp)   || 20d10+180 (290      |
| Dice:** |         | hp)     |
+----------------------+----------------------+----------------------+
| **Initia            || --5    || --5    |
| tive:** |                      |                      |
...
| peed:** | climb 20 ft.         | climb 20             |
|                      |         | ft.     |
+----------------------+----------------------+----------------------+
| **Armor             || 3 (--2 size, --5    || 1 (--4 size, --5    |
| C                    | Dex), touch 3,       | Dex), touch 1,       |
...
| pple:** |                      |                      |
+----------------------+----------------------+----------------------+
| **At                || Slam +8 melee       || Slam +19 melee      |
| tack:** | (2d6+4 plus 2d6      | (3d6+12 plus 3d6     |
|                      | acid)   | acid)   |
+----------------------+----------------------+----------------------+
| **Full              || Slam +8 melee       || Slam +19 melee      |
| At                   | (2d6+4 plus 2d6      | (3d6+12 plus 3d6     |
| tack:** | acid)   | acid)   |
+----------------------+----------------------+----------------------+
| **Space/R           || 15 ft./10           || 20 ft./20           |
| each:** | ft.     | ft.     |
+----------------------+----------------------+----------------------+
| **Special           || Acid, constrict     || Acid, constrict     |
| Att                  | 2d6+4 plus 2d6 acid, | 2d8+12 plus 2d6      |
| acks:** | improved grab        | acid, improved       |
|                      |         | grab    |
+----------------------+----------------------+----------------------+
| **Special           || Blindsight 60 ft.,  || Blindsight 60 ft.,  |
| Quali                | split, ooze          | split, ooze          |
| ties:** | traits  | traits  |
+----------------------+----------------------+----------------------+
| **S                 || Fort +9, Ref --2,   || Fort +15, Ref +1,   |
| aves:** | Will                 | Will +1 |
|                      | --2     |                      |
+----------------------+----------------------+----------------------+
| **Abili             || Str 17, Dex 1, Con  || Str 26, Dex 1, Con  |
| ties:** | 22, Int ---, Wis 1,  | 28, Int ---, Wis 1,  |
|                      | Cha 1   | Cha 1   |
+----------------------+----------------------+----------------------+
| **Sk                || Climb               || Climb               |
| ills:** | +11     | +16     |
...
+----------------------+----------------------+----------------------+
| **Align             || Always              || Always              |
| ment:** | neutral | neutral |
+----------------------+----------------------+----------------------+
| **Advance           || 11--15 HD (Huge);   || ---    |
| ment:** | 16--30 HD            |                      |
|                      | (Garg                |                      |
|                      | antuan) |                      |
+----------------------+----------------------+----------------------+
...
stone. Any melee hit or constrict attack deals acid damage, and the
opponent's armor and clothing dissolve and become useless immediately
unless they succeed on DC 21 Reflex saves. A metal or wooden weapon that
strikes a black pudding also dissolves immediately unless it succeeds on
a DC 21 Reflex save. The save DCs are Constitution-based.

The pudding's acidic touch deals 21 points of damage per round to
...
Inorganic material remains trapped and visible inside the cube's
body.
...
cube can simply mow down Large or smaller creatures as a standard
action. It cannot make a slam attack during a round in which it engulfs.
The gelatinous cube merely has to move over the opponents, affecting as
many as it can cover. Opponents can make opportunity attacks against the
cube, but if they do so they are not entitled to a saving throw. Those
who do not attempt attacks of opportunity must succeed on a DC 13 Reflex
save or be engulfed; on a success, they are pushed back or aside
(opponent's choice) as the cube moves forward. Engulfed creatures are
subject to the cube's paralysis and acid, and are considered to be
...
**Transparent (Ex):** Gelatinous cubes are hard to see,
even under ideal conditions, and it takes a DC 15 Spot check to notice
...
The ooze's acidic touch deals 16 points of damage per round to wooden
or metal objects, but the ooze must remain in contact with the object
for 1 full round to deal this damage.

**Constrict (Ex):** A gray ooze deals automatic slam and
...
even under ideal conditions, and it takes a DC 15 Spot check to notice
one. Creatures who fail to notice a gray ooze and walk into it are
...
electricity attacks deal no damage to an ochre jelly. Instead the
creature splits into two identical jellies, each with half of the
original's current hit points (round down). A jelly with 10 hit points
or less cannot be further split and dies if reduced to 0 it
points.

**Skills:** An ochre jelly has a +8 racial bonus on Climb
...
Orcs are proficient with all simple weapons, preferring those that
cause the most damage in the least time. Many orcs who take up the
warrior or fighter class also gain proficiency with the falchion or the
greataxe as a martial weapon. They enjoy attacking from concealment and
setting ambushes, and they obey the rules of war (such as honoring a
...
**Orc Traits (Ex):** Orcs possess the following racial
traits. 

--- +4 Strength, --2 Intelligence, --2 Wisdom, --2
Charisma.
...
racial adjustments: Str 13, Dex 11, Con 12, Int 10, Wis 9, Cha
8.

### HALF-ORCS

These orc--human crossbreeds can be found in either orc or human
society (where their status varies according to local sentiments), or in
...
**Half-Orc Traits (Ex):** Half-orcs possess the following
racial traits.
...
**Constrict (Ex):** An otyugh deals automatic tentacle
...
**Improved Grab (Ex):** To use this ability, an otyugh
must hit with a tentacle attack. It can then attempt to start a grapple
...
Giant owls are nocturnal birds of prey, feared for their ability to
hunt and attack in near silence. They are intelligent, and though
naturally suspicious, sometimes associate with good creatures. A typical
giant owl stands about 9 feet tall, has a wingspan of up to 20 feet, and
resembles its smaller cousins in nearly every way except
size.
...
**Superior Low-Light Vision (Ex):** A giant owl can see
five times as far as a human can in dim light.

**Skills:** Giant owls have a +8 racial bonus on Listen
checks and a +4 racial bonus on Spot checks.
...
**Improved Grab (Ex):** To use this ability, an owlbear
...
Pegasus eggs are worth 2,000 gp each on the open market, while young
are worth 3,000 gp per head. Pegasi mature at the same rate as horses.
Professional trainers charge 1,000 gp to rear or train a pegasus, which
serves a good or neutral master with absolute faithfulness for
life.

**Carrying Capacity:** A light load for a pegasus is up
...
**Greater Invisibility (Su):** This ability is constant,
...
A phasm is an amorphous creature that can assume the guise of almost
any other creature or object. A phasm in its natural form is about 5
feet in diameter and 2 feet high at the center. Swirls of color indicate
...
**Tremorsense (Ex):** A phasm can automatically sense the
location of anything within 60 feet that is in contact with the ground,
so long as it is touching the ground itself.

**Skills:** \*When using shapechange, a phasm gains a +10
...
Most aasimars are decidedly good-aligned. They fight against evil
causes and attempt to sway others to do the right thing. Occasionally
they take on the vengeful, judgmental aspect of their celestial
ancestor, but this is rare. Combat
...
**Skills:** An aasimar has a +2 racial bonus on Spot and
Listen checks.
...
Dwarven, Elven, Gnome, Halfling, Sylvan.
...
within 60 feet by nonvisual means (mostly hearing and scent, but also by
noticing vibration and other environmental clues). Opponents the
pseudodragon can't actually see still have total concealment against the
pseudodragon.

**Telepathy (Su):** Pseudodragons can communicate
telepathically with creatures that speak Common or Sylvan, provided they
are within 60 feet.
...
The body of a mature purple worm is 5 feet in diameter and 80 feet
...
grapple check. Once inside, the opponent takes 2d8+12 points of crushing
damage plus 8 points of acid damage per round from the worm's gizzard. A
...
a rakshasa loses its claw and bite attacks (although it often equips
...
additional +10 circumstance bonus on Disguise checks. If reading an
...
---Racial Feats: A rakshasa's outsider levels give it three
feats.
...
---Spells: A rakshasa character casts spells as a 7th-level sorcerer.
...
a ravid animates as though by the spell *animate objects
*(caster level 20th). These objects defend the ravid to
...
long, with a body about 5 feet wide. It weighs about 10,000
pounds.
...
from the remorhaz's gizzard. A swallowed creature can cut its way out by
using a light slashing or piercing weapon to deal 25 points of damage to
the gizzard (AC 15). Once the creature exits, muscular action closes the
...
Creatures striking a remorhaz with natural attacks or unarmed attacks
are subject to this damage, but creatures striking with melee weapons do
not take damage from the remorhaz's heat. This heat can melt or char
weapons; any weapon that strikes a remorhaz is allowed a DC 18 Fortitude
...
a DC 23 Escape Artist check or a DC 19 Strength check. The check DCs are
...
it fires strong, sticky strands. The creature can have up to six strands
at once, and they can strike up to 50 feet away (no range increment). If
...
with its antennae. The creature is relentless, chasing characters over
long distances if they still possess intact metal objects but usually
ceasing its attacks to devour a freshly rusted meal.
...
touch attack with its antennae causes the target metal to corrode,
falling to pieces and becoming useless immediately. The touch can
destroy up to a 10-foot cube of metal instantly. Magic armor and
...
immediately. Wooden, stone, and other nonmetallic weapons are
unaffected.
