...
<table>
  <tbody>
    ...
    <tr>
      <th>Attack:</th>
      <td>Hoof –2 melee (1d6+1*)</td>
    </tr>
    <tr>
      <th>Full Attack:</th>
      <td>2 hooves –2 melee (1d6+1*)</td>
    </tr>
    <tr>
      <th>Space/Reach:</th>
      <td>10 ft./5 ft.</td>
...
The rhinoceros is infamous for its bad temper and willingness to
charge intruders.
...
**Skills:** A giant squid has a +8 racial bonus on any Swim heck to perform some special action or avoid a hazard. It can always choose to take 10 on a Swim check, even if distracted or endangered. It can use the run action while swimming, provided it swims in a straight line.
...
| **Feats:**               | Track<sup>B</sup>, Weapon Focus (bite)         |
| **Environment:**         | Temperate forests                                            |
| **Organization:**        | Solitary, pair, or pack (7–16)                               |
| **Challenge Rating:**    | 1                                                            |
