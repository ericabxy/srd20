...
|---------|---------|---------|---------|---------|---------|---------+
| **      | *       | *       | **Ref** | *       | **Sp    | *       |
| Level** | *Base** | *Fort** |         | *Will** | ecial** | *Spells |
|         |         |         | *       |         |         | per     |
|         | **A     | *       | *Save** | *       |         | Day**   |
|         | ttack** | *Save** |         | *Save** |         |         |
|         |         |         |         |         |         |         |
...
| Level | Special
| ----- | -------
| 1st   | Sneak attack +1d6, death attack, poison use, spells
| 2nd   | +1 save against poison, uncanny dodge
| 3rd   | Sneak attack +2d6
| 4th   | +2 save against poison
| 5th   | Improved uncanny dodge, sneak attack +3d6
| 6th   | +3 save against poison
| 7th   | Sneak attack +4d6
| 8th   | +4 save against poison, hide in plain sight
| 9th   | Sneak attack +5d6
| 10th  | +5 save against poison
...
| Level | Special
| ----- | -------
| 1st   | Aura of evil, *detect good,* poison use
| 2nd   | Dark blessing, smite good 1/day
| 3rd   | Command undead, aura of despair
| 4th   | Sneak attack +1d6 
| 5th   | Fiendish servant, smite good 2/day 
| 6th   |
| 7th   | Sneak attack +2d6
| 8th   |
| 9th   |
| 10th  | Sneak attack +3d6, smite good 3/day

#### Table: Blackguard Spells per Day
...
| Character Level | Bonus HD | Natural Armor Adj. | Str Adj. | Int
| --------------- | :------: | :----------------: | :------: | :-:
| 12th or lower   |    +2    |         +1         |    +1    |  6
| 13th–15th       |    +4    |         +3         |    +2    |  7
| 16th–18th       |    +6    |         +5         |    +3    |  8
| 19th–20th       |    +8    |         +7         |    +4    |  9
...
| --------------- | ---------------------
| 12th or lower   | Empathic link, improved evasion, share saving throws, share spells
| 13th–15th       | Speak with blackguard
| 16th–18th       | Blood bond
| 19th–20th       | Spell resistance
...
| Level | Special                                             | Bonus Spells
| ----- | --------------------------------------------------- | :----------:
| 1st   | Natural armor increase (+1)                         | 1
| 2nd   | Ability boost (Str +2), claws and bite              | 1
| 3rd   | Breath weapon (2d8)                                 | 0
| 4th   | Ability boost (Str +2), natural armor increase (+2) | 1
| 5th   | Blindsense 30 ft.                                   | 1
| 6th   | Ability boost (Con +2)                              | 1
| 7th   | Breath weapon (4d8), natural armor increase (+3)    | 0
| 8th   | Ability boost (Int +2)                              | 1
| 9th   | Wings                                               | 1
| 10th  | Blindsense 60 ft., dragon apotheosis                | 0
...
**Bonus Spells:** Dragon disciples gain bonus spells as they gain levels in this prestige class, as if from having a high ability score, as given on [Table: The Dragon Disciple](#table-the-dragon-disciple). A bonus spell can be added to any level of spells the disciple already has the ability to cast.
...
**Natural Armor Increase (Ex):** At 1st, 4th, and 7th level, a gains an increase to the character's existing natural armor (if any), as indicated on [Table: The Dragon Disciple](#table-the-dragon-disciple) (the numbers represent the total increase gained to that point). As his skin thickens, a dragon disciple takes on more and more of his progenitor's physical aspect.
...
[Multiattack](MonsterFeats#multiattack) feat reduces this penalty to only --2.

**Ability Boost (Ex):** As a dragon disciple gains levels in this prestige class, his ability scores increase as noted on [Table: The Dragon Disciple](#table-the-dragon-disciple).
...
|---------|---------|---------|---------|---------|---------|---------+
| ######  | *       | *       | **Ref** | *       | **AC    | **Sp    |
| # Level | *Base** | *Fort** |         | *Will** | Bonus** | ecial** |
|         |         |         | *       |         |         |         |
|         | ####### | *       | *Save** | *       |         |         |
|         |  Attack | *Save** |         | *Save** |         |         |
|         |         |         |         |         |         |         |
...
|                      |                      |                      |
|----------------------|----------------------|----------------------+
| 1                    | Instant mastery      | 4 ranks of a skill   |
|                      |                      | in which the         |
|                      |                      | character has no     |
|                      |                      | ranks                |
|----------------------|----------------------|----------------------+
...
|----------------------|----------------------|----------------------+
| 3                    | Secrets of inner     | +2 bonus on Will     |
|                      | strength             | saves                |
|----------------------|----------------------|----------------------+
| 4                    | The lore of true     | +2 bonus on          |
|                      | stamina              | Fortitude saves      |
|----------------------|----------------------|----------------------+
