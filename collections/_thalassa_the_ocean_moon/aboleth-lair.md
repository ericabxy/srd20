...
_Treasure:_ A collection of crude tools (150 gp value) and one memory-inscribed coral shard (treat as a scroll with 1d3 spells of _detect thoughts_).
...
- [aboleth](/MonstersIntro-A#aboleth)
- [chuul](/MonstersB-C#chuul)
- [locathah](/MonstersK-L#locathah)
...
- Paralytic gland sacs: alchemical paralysis agents, medical anestherics, crafting components for _hold_ and _slow_ effects.
