...
_The Hunt_ as an Economic Ritual/Event
--------------------------------------
...
Optional: Many of these items are _perishable_ and should be "spent" quickly.
...
Optional: Some of these items _destabilize_ over time, losing their value.
...
Optional: Some of these materials _grow_ or _mutate_, making them unreliable if not spent immediately.
...
The more an art object is worth, the more people will ask _why you have it_ rather than _how much it is worth_.
