...
+----------------------+----------------------+---------------------+
| **Changed Subject    | **Increase to        |                     |
| Is:**                | Duration Factor^1^** |                     |
+----------------------+----------------------+---------------------+
|                      |                      |                     |
+----------------------+----------------------+---------------------+
| Same kingdom         | +5                   |                     |
...
|                  |          |                  |                 |
+------------------+----------+------------------+-----------------+
| Red              | 1st      | Stops nonmagical | *Cone of cold*  |
|                  |          | ranged weapons.  |                 |
|                  |          |                  |                 |
|                  |          | Deals 20 points  |                 |
|                  |          | of fire damage   |                 |
|                  |          | (Reflex half).   |                 |
+------------------+----------+------------------+-----------------+
| Orange           | 2nd      | Stops magical    | *Gust of wind*  |
|                  |          | ranged weapons.  |                 |
|                  |          |                  |                 |
|                  |          | Deals 40 points  |                 |
|                  |          | of acid damage   |                 |
|                  |          | (Reflex half).   |                 |
+------------------+----------+------------------+-----------------+
| Yellow           | 3rd      | Stops poisons,   | *Disintegrate*  |
|                  |          | gases, and       |                 |
|                  |          | petrification.   |                 |
|                  |          |                  |                 |
|                  |          | Deals 80 points  |                 |
...
|                  |          | half).           |                 |
+------------------+----------+------------------+-----------------+
| Green            | 4th      | Stops breath     | *Passwall*      |
|                  |          | weapons.         |                 |
|                  |          |                  |                 |
|                  |          | Poison (Kills;   |                 |
|                  |          | Fortitude        |                 |
...
|                  |          | damage instead). |                 |
+------------------+----------+------------------+-----------------+
| Blue             | 5th      | Stops divination | *Magic missile* |
|                  |          | and mental       |                 |
|                  |          | attacks.         |                 |
|                  |          |                  |                 |
|                  |          | Turned to stone  |                 |
...
|                  |          | *spell).         |                 |
+------------------+----------+------------------+-----------------+
| Violet           | 7th      | Energy field     | *Dispel magic*  |
|                  |          | destroys all     |                 |
|                  |          | objects and      |                 |
|                  |          | effects.**^1^**  |                 |
|                  |          |                  |                 |
