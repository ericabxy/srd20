...
ranging from --5 to +5. Table: Ability Modifiers and Bonus Spells shows the modifier for each score. It also shows bonus spells, which you'll need to know about if your character is a spellcaster.
...
<table>
  <thead>
    <tr>
      <th colspan=12>Table: Ability Modifiers and Bonus Spells</th>
    </tr>
    <tr>
      <th rowspan=2>Score</th>
      <th rowspan=2>Modifier</th>
      <th colspan=10>Bonus Spells (by Spell Level)</th>
    </tr>
    <tr>
      <th>0</th>
      <th>1st</th>
  ...
  <tbody>
    ...
    <tr>
      <td colspan=12>etc. . .</td>
    </tr>
	</tbody>
</table>### ABILITIES AND SPELLCASTERS
