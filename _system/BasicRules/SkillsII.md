...
on Hide checks depending on its size parent: Fine +16, Diminutive +12,
...
Combat, Ride-By Attack, Spirited Charge, Trample.
...
effect), even if that person isn't aware of it. The usual DC is 25,
but if the target is dominated (see *dominate person*), the DC is only
15 because of the limited range of the target's activities.
