...
creature's size had increased by one parent: 1d2, 1d3, 1d4, 1d6, 1d8,
...
**Benefits:** The creature can choose to start a grapple
...
damage. A snatched opponent held in the creature's mouth is not allowed
a Reflex save against the creature's breath weapon, if it has
one.

The creature can drop a creature it has snatched as a free action or
use a standard action to fling it aside. A flung creature travels 1d6 x
...
altitude during a round when it executes a wingover, but it can
dive.
